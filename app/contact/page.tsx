          ...
          <div className="space-y-8">
              ...
              <CardContent className="space-y-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@nextstepnavigator.com</p>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Visit our office for in-person career counseling sessions.</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div>
            ...
            <Card className="mt-8">
              <CardHeader>
                ...
                <CardDescription>Meet the career guidance experts behind NextStep Navigator.</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="text-center">
                    ...
                    <h3 className="font-medium text-gray-900">Dr. Sarah Rodriguez</h3>
                    <p className="text-sm text-gray-600">Career Counselor</p>
                    <p className="text-sm text-gray-500">sarah@nextstepnavigator.com</p>
                  </div>
                  <div className="text-center">
                    <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <p className="text-sm text-gray-600">Industry Specialist</p>
                    <p className="text-sm text-gray-500">michael@nextstepnavigator.com</p>
                  </div>
                </div>
              </CardContent>
            </Card>
